...
const EnergySavedCard = () => {
  return (
    <div className="bg-secondary-container-bg rounded-3xl  p-5 flex justify-between w-full">
      ...
      <p className="font-secondary text-secondary-text">Connected Appliances</p>
      </div>
      <button className="rounded-full flex justify-center items-center">
        ...
        <div className="flex items-center  gap-2   ">
          <span className=" font-primary text-primary-h1 text-primary-text-inverse">4300 kWh</span>
          <span className="font-secondary text-sm  text-secondary-text">3% savings then <br></br> the last month</span>
        </div>
      </div>
